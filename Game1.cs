...
public class Game1 : Game
{
    ...
    protected override void Initialize()
    {
        ...
        heart = new HeartItem(64, new Vector2(0,0), null, 10, 0);
        player = new Player(64, null, new Vector2(940, 1000), 25, 300, 100, 25, null, this);//baseHealth, baseDamage, baseShield, speed
